...
pacman::p_load(stringr, tibble, ggraph, ggplot2, readr, dplyr, tidyverse, tidytext, purrr, data.table, lattice)
```
...
```{r}
barchart(word ~ N | Location, dt_words_location[, head(.SD, 15), by = Location],

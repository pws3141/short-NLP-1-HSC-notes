...
```{r}
dt_top15 <- dt_words_location[, head(.SD, 15), by = Location]
dt_top15
barchart(word ~ N | Location, dt_top15,
  scales = list(
    x = list(relation = "free"),     # free x-axis scales per panel
    y = list(relation = "free")      # free y labels per panel
  )
)
```
